...
async function main() {
  ...
  // Use your Hardhat local accounts here
  const recipients = [
    getAddress(account.address), // me
  ...
  console.log("Airdrop:", txBatch, "gasUsed:", rBatch.gasUsed.toString(), "fee(wei):", feeBatch.toString());
